# Generated by Django 3.2.18 on 2023-04-08 15:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=30)),
                ('type', models.CharField(choices=[('ward', 'ward'), ('special', 'special'), ('technical', 'technical')], max_length=30)),
        ...
        migrations.AddField(
            model_name='student',
            name='wilaya_id',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.wilaya'),
        ),
        migrations.AddField(
            model_name='student',
            name='year',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=30)),
                ('wilaya_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.wilaya')),
            ],
            options={
                'db_table': 'kata',
            },
